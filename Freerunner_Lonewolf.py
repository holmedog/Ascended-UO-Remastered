...
SCAN_RANGE = 12
ENGAGE_RANGE = 10
ROAM_RANGE = 18           # how far to look for a creature to run to
...
def roam_point():
    return (API.Player.X + rnd(21) - 10, API.Player.Y + rnd(21) - 10)
...
while not API.StopRequested:
    ...
    if current_time - last_buff_time >= BUFF_DELAY and not API.Player.IsPoisoned and hp_percent() > HEAL_PERCENT:
